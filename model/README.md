...
Pretrained weights for [nagisa-rs](https://github.com/Kilerd/ragisa), from
...
This crate is installed automatically by nagisa-rs's default `bundled-model`
feature. Applications should depend on `nagisa-rs` and use `Tagger::new()`
or `JaSegmenter::new()`.
...
needed. The format is versioned and internal to the matching nagisa-rs
